...
var aesEncrypt = function aesEncrypt(plainText, secret) {
  ...
  var cipher = crypto.createCipheriv('aes-256-cbc', key, iv); // Encrypt the plaintext
...
exports.hreConfig = hreConfig;
exports.hreInit = hreInit;
